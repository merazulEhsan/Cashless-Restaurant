export const data = [
    {
      ...
      price: '৳ 480',
      description:"Two charbroiled all-beef patties, American cheese, onions, ketchup, mustard and dill pickles on a plain bun 380 cals",
    },
    {
      id: 2,
      name: 'Cheeseburger',
      ...
      price: '৳ 380',
      description:"One charbroiled all-beef patties, American cheese, onions, ketchup, mustard and dill pickles on a plain bun 303 cals",
    },
    {
      id: 3,
      ...
      price: '৳ 300',
      description:"Mushroom burgers are the steak of veggie burgers. Serve these on buns with lettuce, tomato, and aioli sauce. Oh yeah!"
    },
    {
      id: 4,
      name: 'Loaded Burger',
      ...
      price: '৳ 460',
      description:"Loaded Burgers with bacon, caramelized onions, and avocado crema will blow your mind! This easy bacon cheeseburger recipe is packed with so much flavor, that it's a guaranteed hit on the grill or the stove."
    },
    {
      id: 5,
      name: 'Feta & Spinnach',
      ...
      price: '৳ 1199',
      description:"Creamy Spinach with Feta. A wonderful side dish to any meal offering a lovely creamy texture backed up by some serious flavor! Don't know what to make as a side? Give this one a try!"
    },
    {
      id: 6,
      name: 'Supreme Pizza',
    ...
    },
    {
      ...
      price: '৳ 850',
      description:'Italian chicken sausage, beef pepperoni, ground beef, fresh mozzarella, roasted red pepper, roasted garlic and caramelized onions.'
    },
    {
      id: 8,
      name: 'Cheese Pizza',
    ...
    },
    {
      ...
      price: '৳ 99',
      description:"A Caesar salad (also spelled Cesar and Cesare) is a green salad of romaine lettuce and croutons dressed with lemon juice (or lime juice), olive oil, egg, Worcestershire sauce, anchovies, garlic, Dijon mustard, Parmesan cheese, and black pepper."
    },
    {
      id: 11,
      name: 'Loaded Salad',
      ...
      price: '৳ 110',
      description:"These meal sized loaded salads look amazing! I'm always worried that I won't be full after eating a salad for dinner, but these salads are... well... loaded! They've got tons of veggies, fruits, nuts, seeds, cheese and protein to keep you satisfied."
    },
    {
      id: 12,
      name: 'Fruit Salad',
      ...
      price: '৳ 99',
      description:"This fantastic fruit salad combines pineapple, kiwi, bananas, oranges, grapes, and berries in a sweet citrusy sauce for a colorful dessert."
    },
    {
      id: 13,
      name: 'Wings',
      ...
      price: '৳ 490',
      description:"Using a special ingredient you have in your kitchen pantry already! Tossed in a delicious Buffalo Sauce, these wings are a hit and a reader favourite!"
    },
    {
      id: 14,
      name: 'Baked Chicken',
    ...
    },
    {
      ...
      price: '৳ 590',
      description:"Crispy Baked Chicken Tenders soaked in lemon garlic flavours. Coated in a golden parmesan Panko crumb creates an addictive crunch! No flour needed!"
    },
    {
      id: 16,
      name: 'Chicken Kabob',
      ...
      price: '৳ 360',
      description:"These grilled chicken kabobs are made with marinated chicken and colorful vegetables, all threaded onto skewers and cooked to perfection."
    },
  ];
