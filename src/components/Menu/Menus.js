    ...
    <>
      <div className="h-screen bg-cover bg-center bg-no-repeat bg-hero flex justify-center items-center bg-fixed scroll-smooth  ">
        <div className="flex text-white h-full w-full bg-opacity-40 bg-black relative">
          <div className="lg:w-1/2 m-auto items-center">
            <p className="uppercase text-center font-nunito tracking-[0.2em] font-black text-[12px] leading-10">
              Have a look
            </p>

            <h1
              className="text-center text-5xl sm:text-7xl font-playfair font-semibold"
              data-aos="fade-up"
            ...
            <p
              className="text-center text-xl p-7 font-marck leading-6"
              data-aos="fade-up"
              data-aos-duration="2500"
            >
              Delight in prime steaks, homemade pastas, fresh salads, and
              exquisite seafood.
            </p>
            ...
            >
              <button
                ...
                className="btn rounded-3xl px-6 bg-orange-500 btn-md border border-none text-white text-xs"
              >
                Explore More
              </button>
            </div>
      ...
      <section className="w-full 2xl:container m-auto">
        <div className="bg-white dark:bg-gray-900 pt-20 pb-10">
          <div
            className="relative w-full md:mb-5 "
            data-aos="fade-up"
          ...
          >
            ...
            <span className="text-xl sm:text-5xl font-serif absolute left-1/4 -translate-y-6 translate-x-4 sm:-translate-y-10 md:left-40 lg:left-1/4 lg:translate-x-10 xl:left-1/3 xl:translate-x-5 text-black dark:text-white font-black">
              Top Rated Menu
            </span>
          </div>
        </div>
        ...
        <div className="max-w-[1640px] m-auto px-4 md:py-4 bg-white dark:bg-gray-900">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 pt-4 pb-14">
            {foods?.slice(page * size, page * size + size).map((item) => (
              <div
                key={item._id}
                data-aos="zoom-in"
                data-aos-duration="1000"
      ...
      <div>
        <nav
          ...
          className="text-center pb-10 bg-white dark:bg-gray-900"
        >
          <ul className="inline-flex -space-x-px">
            <li>
              <button
                onClick={() => setPage(page > pageCount && page - 1)}
                disabled={page === 0}
