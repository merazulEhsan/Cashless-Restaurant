...
export default function User() {
    ...
    const handleUserDelete = () => {
        ...
        const url = `http://localhost:4000/user/${userDelete._id}`;
        fetch(url, {
            method: 'DELETE',
            headers: {
    ...
    // Search Filter
    const userFilter = users.filter((user) => user ?. name ?. toLowerCase().includes(search) || user ?. email.toLowerCase().includes(search));
    ...
    return (<>
        <div className="overflow-x-auto relative shadow-md sm:rounded-lg h-screen">
            ...
            <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody> {userFilter.map((user, index) => (
                                      ...
                                      <div className="modal ">
                                        <div className="modal-box relative bg-white dark:bg-gray-900">
                                          ...
                                          <div className="p-6 text-center">
                                            ...
                                            <button onClick={()=>handleUserDelete()} className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                                              Yes, I'm sure
                                            </button> 
                                            <label
                                              htmlFor="my-modal-3"
