            ...
            <section className='bg-white dark:bg-gray-900 h-auto 2xl:container m-auto'>
                <div className="drawer drawer-overlay flex justify-between p-4 md:flex-row flex-col h-auto">
                    ...
                    <div className="drawer order-1 dark:bg-gray-900 dark:text-current text-black card rounded-lg md:ml-6 h-auto">
                        ...
                        {/* <label htmlFor="my-drawer" className="btn btn-primary drawer-button">Open drawer</label> */} </div>
                    <div className="drawer-side">
                        {/* <label htmlFor="my-drawer" className="drawer-content"></label> */}
                        <ul className="menu text-base p-4 w-64 bg-white dark:bg-gray-800 dark:text-current text-black card shadow-lg rounded-lg border-gray-200 dark:border-current">
                            ...
                            {
                                chef && <li>  <Link to="/dashboard/user">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-purple-600">
                             ...
                             {
                                chef &&<li>  <Link to="/dashboard/additem">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-purple-600">
                            ...
                            {
                                chef && <li>  <Link to="/dashboard/manageitems">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-purple-600">
                             ...
                             {
                                chef &&<li>  <Link to="/dashboard/allorders">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-purple-600">
                                        <path d="M2.25 2.25a.75.75 0 000 1.5h1.386c.17 0 .318.114.362.278l2.558 9.592a3.752 3.752 0 00-2.806 3.63c0 .414.336.75.75.75h15.75a.75.75 0 000-1.5H5.378A2.25 2.25 0 017.5 15h11.218a.75.75 0 00.674-.421 60.358 60.358 0 002.96-7.228.75.75 0 00-.525-.965A60.864 60.864 0 005.68 4.509l-.232-.867A1.875 1.875 0 003.636 2.25H2.25zM3.75 20.25a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0zM16.5 20.25a1.5 1.5 0 113 0 1.5 1.5 0 01-3 0z"/>
                                    </svg>
                                    All Orders</Link>
