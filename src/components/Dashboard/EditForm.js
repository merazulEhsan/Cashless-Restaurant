  ...
  return (
    <>
      <label className="modal-box cursor-pointer bg-white">
        ...
        <form onSubmit={handleEdit} className="overflow-x-auto relative ">
          ...
          <div className="p-6 space-y-4">
            ...
            <button
              type="submit"
              className="modal-middle text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              Update
            </button>
            {/* <!-- Modal footer --> */}
