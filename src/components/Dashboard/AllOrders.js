...
export const AllOrders = () => {
    ...
    useEffect(() => {
        fetch(`http://localhost:4000/allorders`).then((res) => res.json()).then((data) => {
            setOrders(data);
            setIsLoading(false);
                              ...
                              <td className="py-4 px-6 font-semibold text-gray-900 dark:text-white">
                                {
                                  ...
                                  Delivered
                                </span>:<button onClick={()=>handleDeliverd(order._id)} className="btn btn-xs px-4 dark:text-white btn-info">
                                  Complete
                                </button> 
                                }
                              </td>
