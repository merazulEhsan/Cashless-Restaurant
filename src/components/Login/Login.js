            ...
            <div className="container m-auto sm:p-4 lg:p-5 relative h-screen flex ">
                ...
                <div className='flex justify-evenly rounded-md items-center bg[#f6f7fb] sm:shadow-2xl lg:w-3/4 m-auto'>
                    <div className='p-4 sm:1/2 lg:w-1/3 '>
                        ...
                        <form className=' '>
                            <div className='mb-2'>
                                <label for="small-input" class="block mb-1 text-sm font-medium text-black dark:text-gray-300">E-mail</label>
                                <input type="text" id="small-input" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='demo@gmail.com'/>
                            </div>
                            <div className='mb-3'>
                                <label for="small-input" class="block mb-1 text-sm font-medium text-black dark:text-gray-300">Password</label>
                                <input type="text" id="small-input" class="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='anyPassword192'/>
                            </div>
                            ...
                            <div className='text-center'>
                                <button class="mt-4 relative inline-flex items-center justify-center p-0.5 mb-2 mr-2 overflow-hidden text-sm font-medium text-gray-900 rounded-lg group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
                                    <span class="relative px-24 py-1.5 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0">
                                        Log In
                                    </span>
                                </button>
                            </div>
                        ...
                        <p className='text-center cursor-pointer hover:underline dark:text-white text-black'>Create Account</p>
                    </div>
