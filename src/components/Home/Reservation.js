...
export default function Reservation() {
    return (
        <section className='w-full container m-auto'>
            ...
            <div className='mb-10 relative flex flex-col sm:flex-row backdrop:blur-lg md:p-4 lg:p-10 '>
                <div className='w-3/4 '>
                    <img  src={img}
                        alt=""/>
                </div>
                <div className='w-1/2 bg-black bg-opacity-60 h-auto md:absolute lg:right-5 md:right-3 xl:right-10 md:translate-y-5 lg:translate-y-11 xl:translate-y-1/3 rounded-md drop-shadow-lg shadow-inner shadow-fuchsia-500/50 '>
                    <form className='w-full lg:w-5/6 md:p-4 lg:p-7 m-auto'>
                        <div className='flex justify-between md:gap-4'>
                            <div class="relative z-0">
                                <input type="text" id="small_standard" class="block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
                        ...
                        <div className='flex justify-between mt-7 md:gap-4 lg:gap-1'>
                            <div class="relative z-0">
                                <input type="text" id="small_standard" class="block py-2 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
