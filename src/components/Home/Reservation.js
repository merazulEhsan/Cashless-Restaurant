                ...
                <div className='sm:w-1/2 p-3 sm:p-0 bg-black dark:bg-opacity-60 h-auto md:absolute lg:right-5 md:right-3 xl:right-10 md:translate-y-5 lg:translate-y-11 xl:translate-y-1/3 rounded-md drop-shadow-lg shadow-inner shadow-fuchsia-500/70 '>
                    <form onSubmit={handleSubmit}
                        ...
                        <div className='flex justify-between mt-7 gap-6 md:gap-4 lg:gap-1'>
                            <div className="relative z-0">
                                <input name='date' type="text" id="small_standard" className="block py-2 px-0 w-full text-sm  bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
                            ...
                            <div className="relative z-0">
                                <input name='time' type="text" id="small_standard" className="block py-2 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" "/>
