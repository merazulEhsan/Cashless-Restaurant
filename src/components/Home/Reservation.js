    ...
    <section className="w-full 2xl:container m-auto bg-white dark:bg-gray-900">
      <div className=" pt-10 pb-10">
        ...
        >
          ...
          <span className="text-xl sm:text-5xl font-serif absolute left-1/4 -translate-y-6 translate-x-4 sm:-translate-y-10 md:left-40 lg:left-1/4 lg:translate-x-8 xl:left-1/3 xl:translate-x-1 text-black dark:text-white font-black">
            Make Reservation
          </span>
        </div>
      </div>
            ...
            <div className="flex justify-between gap-6 md:gap-4">
              <div className="relative z-0">
                <input
                  ...
                  type="text"
                  id="small_standard"
                  className="block py-2 px-0 w-full text-sm bg-transparent border-0 border-b-2 border-gray-300 appearance-none text-white dark:border-gray-600 dark:focus:border-white focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                  placeholder=" "
                />
                <label
