                ...
                <div className='max-w-[1640px] m-auto px-4 md:py-4 bg-white dark:bg-gray-900'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 pt-4 mb-14' >
                        ...
                        foods.map((item, index) => (
                            <div key={index} data-aos="zoom-in" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="true">
                                <div 
                                className='border shadow-md dark:shadow-blue-600 rounded-lg hover:scale-105 duration-300 cursor-pointer' >
                                <img src={
                                        item.image
                                    }
                                    alt={
