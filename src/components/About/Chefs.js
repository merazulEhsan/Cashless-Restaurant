    ...
    return (
        <section className='w-full bg-gray-50 sm:p-5 2xl:container m-auto dark:bg-gray-900 relative '>
            ...
            <div className='relative w-full py-10'>
                ...
                <span className='text-2xl sm:text-5xl font-serif absolute left-1/4 -translate-y-6 sm:-translate-y-10 md:left-48 lg:left-1/3 xl:left-1/3 xl:translate-x-4 text-black dark:text-white font-black'>Professional Chef</span>
            </div>

            <div className='mt-20 pb-20 m-auto' data-aos="fade-up" data-aos-duration="3000">
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-20  justify-items-center max-w-screen-2xl'>
                    <div className='group bg-gray-900 dark:bg-white/5 backdrop:blur-sm w-60 p-5 rounded-md h-80 sm:h-64 sm:hover:h-80 transition-all duration-500 ease-linear shadow-inner shadow-blue-500 '>
                    ...
                    <div className='group bg-gray-900 dark:bg-white/5 backdrop:blur-sm w-60 p-5 rounded-md h-80 sm:h-64 sm:hover:h-80 transition-all duration-500 ease-linear shadow-inner shadow-pink-400 '>
                        <div className='relative z-10'>
                            <img className='absolute -translate-y-16 shadow-md shadow-white/10 rounded-md'
                                src={headChef}
                                alt=""/>
                    ...
                    <div className='group bg-gray-900 dark:bg-white/5 backdrop:blur-sm w-60 p-5 rounded-md h-80 sm:h-64 sm:hover:h-80 transition-all duration-500 ease-linear shadow-inner shadow-green-400/70 '>
                        <div className='relative z-10'>
                            <img className='absolute -translate-y-16 shadow-md shadow-white/10 rounded-md'
                                src={cook}
                                alt=""/>
