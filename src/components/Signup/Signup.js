                ...
                <div className=' flex justify-evenly rounded-md sm:shadow-2xl items-center md:flex-row-reverse lg:w-4/5 '>
                    <div className='p-8 sm:1/3 lg:w-1/3'>
                        ...
                        <form onSubmit={handleCreateAccount}>
                            <div className='mb-2'>
                                <label htmlFor="small-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-300">Name</label>
                                <input name='name' type="text" id="small-input" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='Tom Cruise' required/>
                            </div>
                            <div className='mb-2'>
                                <label htmlFor="small-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-300">E-mail</label>
                                <input name='email' type="email" id="small-input" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='demo@gmail.com' required/>
                            </div>
                            <div className='mb-2'>
                                <label htmlFor="small-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-300">Password</label>
                                <input name='password' type="password" id="small-input" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='anyPassword192' required/>
                            </div>
                            <div className='mb-1'>
                                <label htmlFor="small-input" className="block mb-1 text-sm font-medium text-gray-900 dark:text-gray-300">Confirm Password</label>
                                <input name='cpassword' type="password" id="small-input" className="block p-2 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder='anyPassword192' required/>
                            </div>
                            <p>
                    ...
                    <a href='/'>Reset Password</a>
                        ...
                        <div className='text-center'>
                        <Link to='/login' className='text-center cursor-pointer hover:underline mt-3 dark:text-white text-black'>Already Have account?</Link>
                        </div>
                    </div>
